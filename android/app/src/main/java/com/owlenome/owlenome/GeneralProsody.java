...
public class GeneralProsody {
     ...
     * //ToDo: что за мистика? Разобраться. UPD: там была ошибка какая-то в логике,
     * для 7 долей проявлялась. Поэтому гипотеза должна быть верной, а алгоритм надо править.
     *Насколько я вижу (17.06.20), сейчас используется для генерации акцентов в поддолях.
     * Поэтому при 7 поддолях будет ГЛЮК! //ToDo
     *
     */
